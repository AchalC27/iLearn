...
<header class="main-db-header">
    <div class="main-db-header-inner">
        ...
        <nav class="database-switcher" aria-label="Application switcher">
            <a class="database-button ilearn-button" href="../index.php?app=ilearn_mysql&amp;page=<?= urlencode($currentPage) ?>">
                <span class="database-name">iLearn</span>
                <span class="database-type">MySQL</span>
            </a>

            <a class="database-button multipie-button active" href="../index.php?app=multipie_psql&amp;page=<?= urlencode($currentPage) ?>">
