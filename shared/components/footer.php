<?php $footerApp = ($_SESSION['selected_app'] ?? 'ilearn_mysql') === 'multipie_psql' ? 'MultiPie' : 'iLearn'; ?>
<footer id="shared-footer" class="cms-footer shared-footer">
  <div class="footer-inner">
    <div class="footer-legal">
      <div class="footer-brand">
        <span class="name"><?= e($footerApp) ?></span>
        <span class="footer-tag">CMS Engine</span>
      </div>
